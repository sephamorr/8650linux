...
build_time_vars = {'AC_APPLE_UNIVERSAL_BUILD': 0,
 ...
 'CC': 'gcc -pthread',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-fno-strict-aliasing -march=armv5te -O2 -pipe -fstack-protector --param=ssp-buffer-size=4 -DNDEBUG -march=armv5te -O2 -pipe -fstack-protector --param=ssp-buffer-size=4',
 'CFLAGSFORSHARED': '-fPIC',
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in Makefile.pre.in',
 'CONFIG_ARGS': "'--prefix=/usr' '--enable-shared' '--with-threads' '--enable-ipv6' '--enable-unicode=ucs4' '--with-system-expat' '--with-system-ffi' '--with-dbmliborder=gdbm:ndbm' 'CFLAGS=-march=armv5te -O2 -pipe -fstack-protector --param=ssp-buffer-size=4' 'LDFLAGS=' 'CPPFLAGS=-D_FORTIFY_SOURCE=2'",
 ...
 'HGTAG': '',
 'HGVERSION': '',
 'HOST_GNU_TYPE': 'armv5tel-unknown-linux-gnueabi',
 'HURD_C_THREADS': 0,
 ...
 'OBJECT_OBJS': '\\',
 'OLDPATH': ':lib-old',
 'OPT': '-DNDEBUG -march=armv5te -O2 -pipe -fstack-protector --param=ssp-buffer-size=4',
 'OTHER_LIBTOOL_OPT': '',
 'PACKAGE_BUGREPORT': 0,
 'PACKAGE_NAME': 0,
 'PACKAGE_STRING': 0,
 ...
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 'PY_CFLAGS': '-fno-strict-aliasing -march=armv5te -O2 -pipe -fstack-protector --param=ssp-buffer-size=4 -DNDEBUG -march=armv5te -O2 -pipe -fstack-protector --param=ssp-buffer-size=4 -I. -IInclude -I./Include -D_FORTIFY_SOURCE=2 -fPIC -DPy_BUILD_CORE',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/build/src/Python-2.7.5:',
 'SCRIPTDIR': '/usr/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TESTPYTHON': 'LD_LIBRARY_PATH=/build/src/Python-2.7.5: ./python -Wd -3 -E -tt',
 'TESTPYTHONOPTS': '',
 ...
 'abs_builddir': '/build/src/Python-2.7.5',
 'abs_srcdir': '/build/src/Python-2.7.5',
