...
"armv5tel-linux-thread-multi-3.2.34-1-farm" or
	die "Errno architecture (armv5tel-linux-thread-multi-3.2.34-1-farm) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
