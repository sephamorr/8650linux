...
cf_by='nobody'
cf_email=''
cf_time='Tue Aug 20 16:01:53 CDT 2013'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
config_arg19='-Dlddlflags=-shared '
config_arg1='-des'
config_arg20='-Dldflags='
config_arg2='-Dusethreads'
config_arg3='-Duseshrplib'
config_arg4='-Doptimize=-march=armv5te -O2 -pipe -fstack-protector --param=ssp-buffer-size=4'
...
mydomain='.nonet'
myhostname='root-armv5-copy'
myuname='linux root-armv5-copy 3.2.34-1-farm #1 smp preempt sat nov 24 02:30:47 utc 2012 armv5tel gnulinux '
n='-n'
need_va_copy='undef'
...
phostname='uname -n'
pidtype='pid_t'
plibpth='/lib/armv5tel-unknown-linux-gnueabi/4.7.2 /lib /usr/lib/armv5tel-unknown-linux-gnueabi/4.7.2 /usr/lib'
pmake=''
pr=''
prefix='/usr'
prefixexp='/usr'
