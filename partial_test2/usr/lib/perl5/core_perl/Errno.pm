...
"armv5tel-linux-thread-multi-3.1.10-9-arch" or
	die "Errno architecture (armv5tel-linux-thread-multi-3.1.10-9-arch) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
